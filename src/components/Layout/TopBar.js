  ...
  <ul className="navbar-nav ml-auto">
      ...
      <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <Link className="dropdown-item d-flex align-items-center" to="/">
          <div className="dropdown-list-image mr-3">
            <img className="rounded-circle" src="https://source.unsplash.com/fn_BT9fwg_E/60x60" alt="true" />
        ...
        <Link className="dropdown-item d-flex align-items-center" to="/">
          <div className="dropdown-list-image mr-3">
            <img className="rounded-circle" src="https://source.unsplash.com/AU4VPcFN4LE/60x60" alt="true" />
        ...
        <Link className="dropdown-item d-flex align-items-center" to="/">
          <div className="dropdown-list-image mr-3">
            <img className="rounded-circle" src="https://source.unsplash.com/CS2uCrpNzJY/60x60" alt="true" />
        ...
        <Link className="dropdown-item d-flex align-items-center" to="/">
          <div className="dropdown-list-image mr-3">
            <img className="rounded-circle" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60" alt="true" />
            <div className="status-indicator bg-success" />
          </div>
          <div>
    ...
    <li className="nav-item dropdown no-arrow">
      <Link className="nav-link dropdown-toggle" to="/" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <img className="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60" alt="true" />
      </Link>
